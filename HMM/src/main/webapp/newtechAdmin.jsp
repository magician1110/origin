			...
			<link href="resources/css/newtechAdmin.css" rel="stylesheet" type="text/css">
				...
				<script type="text/javascript">
					function iOrEdit(wscode) {
						...
						if (disagree.is('span'))
							cdisagree = disagree.text();
						else
							cdisagree = disagree.val();
				...
				<div class="container">
					...
					<c:forEach var="wl" items="${wlist }">
						<div class="newtech_subject">
							...
							<div class="row pro_con">
								<div class="col-sm-6 newtech_pro">
									찬성 :
									<c:if test="${wl.agree  eq null}">
								...
								<div class="col-sm-6 newtech_con">
									반대 :
									<c:if test="${wl.disagree  eq null}">
