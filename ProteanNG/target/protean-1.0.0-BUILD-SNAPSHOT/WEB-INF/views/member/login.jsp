            ...
            <c:choose>
                <c:when test="${null eq member }">
		            <ul class="navbar-nav ml-auto">
		                <li class="nav-item">
		                <script type="text/javascript">alert("zzzzz");</script>
		                    <a class="nav-link" href="#">Login</a>
		                </li>
		                <li class="nav-item">
		                    <a class="nav-link" href="siginUp">Register</a>
		                </li>
		            </ul>
	            </c:when>
	            <c:when test="${null ne member }">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                          <script type="text/javascript">alert("bbbbb");</script>
                            <a class="nav-link" href="#" > ${member.id} </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="card-body">
                        <!--  <form action="" method=""> -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password" class="form-control" name="password" placeholder="비밀번호를 입력해 주세요" required onkeydown='javascript:onEnterSubmit()'">
                                </div>
                            </div>
